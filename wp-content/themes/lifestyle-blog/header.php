...
<?php $menu_sticky = get_theme_mod( 'lifestyle_blog_header_sticky_menu_option', false ); ?>

<?php
	$defaults = "";
	$social_media = get_theme_mod( 'lifestyle_blog_social_media', $defaults );
?>
...
<?php
	...
	$layout = get_theme_mod( 'lifestyle_blog_header_layouts', 'one' );
    if( $layout == 'one' ) {
