...
if ( ! class_exists( 'Lifestyle_Blog_Demo' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class Lifestyle_Blog_Demo {

		/**
		 * Singleton instance of Lifestyle_Blog_Demo.
		 *
		 * @var Lifestyle_Blog_Demo $instance Lifestyle_Blog_Demo instance.
		 */
		...
		/**
		 * Main Lifestyle_Blog_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Lifestyle_Blog_Demo ) ) {
				self::$instance = new Lifestyle_Blog_Demo();
