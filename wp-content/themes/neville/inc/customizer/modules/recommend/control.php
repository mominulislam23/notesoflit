<?php
if( ! class_exists( 'Neville_Installer_Control' ) ) {
	/**
	 * Neville Recommended Plugin Install
	 *
	 * @since 1.0.0
	 */
	class Neville_Installer_Section extends WP_Customize_Section {

		/**
		 * The type of customize section being rendered.
		 */
		public $type = 'neville-installer';
			...
			<li id="accordion-section-{{ data.id }}" class="accordion-section control-section control-section-{{ data.type }} cannot-expand">
				...
				<div class="notice-{{ data.type }}">
					...
					<p>
						...
						href="<?php echo esc_url( neville_create_exts_install_url() ); ?>"
